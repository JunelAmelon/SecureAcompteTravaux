        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Informations légales de la plateforme SecureAcompteTravaux
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            {/* Section Hébergement */}
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#dd7109]">Hébergement</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700">
                <div>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#dd7109]">Propriété intellectuelle</h2>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#dd7109]">Responsabilité</h2>
              <div className="space-y-2 text-gray-700">
            ...
            {/* Section CNIL */}
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-[#dd7109]">Conformité RGPD</h2>
              <div className="space-y-2 text-gray-700">
                <p>Conformément au Règlement Général sur la Protection des Données (RGPD 2016/679) :</p>
